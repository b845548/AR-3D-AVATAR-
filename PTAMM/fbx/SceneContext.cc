...
void SceneContext::OnTimerClick(int anim) const
{
    if (!mPause)
    {
        mStatus = MUST_BE_REFRESHED;
        ...
        if(save!=anim)
        {
            ...
            {
            case 0:// stop
                mCurrentTime=1000000000;
                min=(FbxTime)1000000000;
                max=(FbxTime)29000000000;
            break;
            case 1:// stop
                mCurrentTime=50000000000;
                min=(FbxTime)50000000000;
                max=(FbxTime)130000000000;
            break;
            case 2:// long
                mCurrentTime=150000000000;
                min=(FbxTime)150000000000;
                max=(FbxTime)230000000000;
            break;
            case 3:// short
                mCurrentTime=28000000000;
                min=(FbxTime)28000000000;
                max=(FbxTime)50000000000;
            break;
            default:
            break;
            }
...
// Redraw the scene
bool SceneContext::OnDisplay(float thetaX,float thetaY)
{
