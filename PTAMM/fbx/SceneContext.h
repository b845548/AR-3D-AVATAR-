...
public:
    ...
    void OnTimerClick(int anim) const;
    ...
    // Set the currentlyD selected node from external window system.
	...
	void setMessage(char * str,float x, float y);
